...
authRouter.post("/sendVerifyOtp", userAuth,isAuthenticated, sendVerifyOtp); // import { sendVerifyOtp } from '../controllers/authController.js';
authRouter.post("verify-account", userAuth,isAuthenticated, verifyEmail); // import { verifyEmail } from '../controllers/authController.js';
